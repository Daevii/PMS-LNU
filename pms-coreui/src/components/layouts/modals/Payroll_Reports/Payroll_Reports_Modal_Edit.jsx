...
const Payroll_Reports_Modal_Edit = (id) => {
    ...
    const handleShow = () => {
        ...
        const FetchData = axios.get("http://localhost:8080/payrollreport/" + id.Editid)
            .then(Response => {
                ...
                setGenereatedBy(Response.data.genereated_by);
    ...
    const SaveData = async (e) => {
        ...
        const response = await axios.put("http://localhost:8080/payrollreport/" + id.Editid, {
        ...
        if (response.status === 200) {
            Swal.fire('Success', 'The Payroll Report is updated', 'success').then((result) => {
    ...
    return (
        <>
            ...
            >
                ...
                <Modal.Header>
                    <Modal.Title>Edit Payroll Report</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                            ...
                            <div className="form-group mb-0">
                                <div className="row align-items-center">
                                    <div className="col-12 border-start pb-2 pt-2">
                                        <textarea class="form-control" rows="4" placeholder="Text Here..." value={ReportContent} onChange={(e) => setReportContent(e.target.value)}></textarea>
...
export default Payroll_Reports_Modal_Edit