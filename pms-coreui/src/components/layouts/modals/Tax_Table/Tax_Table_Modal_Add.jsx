...
const Tax_Table_Modal_Add = () => {
    ...
    const SaveData = async (e) => {
        ...
        const response = await axios.post("http://localhost:8080/taxtable/", {
            TaxYear: TaxYear,
        ...
        if (response.status === 201) {
            Swal.fire('Success', 'The Tax Table is added', 'success').then((result) => {
                handleClose();
                setTaxYear('');
                setTaxBracket('');
                setTaxRate('');
    ...
    return (
        <>
            ...
            >
                <Modal.Header>
                    <Modal.Title>Add TaxTable</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <form className="form-horizontal r-separator" onSubmit={SaveData}>
                        <div className="card-body">
                            <h5>Add Tax Table Information</h5>
...
export default Tax_Table_Modal_Add